...
type Bootstrap struct {
	...
	Wx     *WxConf `protobuf:"bytes,3,opt,name=wx,proto3" json:"wx,omitempty"`
}
...
func (x *WxConf) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WxConf) ProtoMessage() {}

func (x *WxConf) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WxConf.ProtoReflect.Descriptor instead.
func (*WxConf) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{3}
}

func (x *WxConf) GetServerToken() string {
	if x != nil {
...
func (x *WxConf) GetSecret() string {
	if x != nil {
		return x.Secret
	}
	return ""
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x81, 0x01, 0x0a, 0x09, 0x42, 0x6f, 0x6f, 0x74, 0x73,
	...
	0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x22, 0x0a, 0x02, 0x77, 0x78, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x57, 0x78, 0x43, 0x6f, 0x6e, 0x66, 0x52, 0x02, 0x77, 0x78, 0x22, 0xb8, 0x02, 0x0a, 0x06, 0x53,
	...
	,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*WxConf)(nil),              // 3: kratos.api.WxConf
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	3,  // 2: kratos.api.Bootstrap.wx:type_name -> kratos.api.WxConf
